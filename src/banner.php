<?php 
	...
	if($token == "success"){ $tresc = 'Twoje konto jest już<br><strong style=\'color:green\'>AKTYWNE</strong><br><br>Zaloguj się do swojego konta'; }
	if($_SESSION['register'] == '200') { $tresc = 'Rejestracja została przeprowadzona<br><strong style=\'color:green\'>POMYŚLNIE</strong>'; }
